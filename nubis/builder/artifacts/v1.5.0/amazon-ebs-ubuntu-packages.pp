...
package { 'duplicity':
  ensure => '0.7.13.1-0ubuntu0ppa1299~ubuntu14.04.1',
}
package { 'e2fslibs':
...
package { 'python-fasteners':
  ensure => '0.12.0-2ubuntu1~14.04.0',
}
package { 'python-gdbm':
